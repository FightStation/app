...
function getMockCountries(): DirectoryCountry[] {
  return [
    { code: 'EE', name: 'Estonia', name_native: 'Eesti', is_active: true, gym_count: 6, last_updated: null },
    { code: 'LV', name: 'Latvia', name_native: 'Latvija', is_active: true, gym_count: 6, last_updated: null },
    { code: 'LT', name: 'Lithuania', name_native: 'Lietuva', is_active: true, gym_count: 6, last_updated: null },
    { code: 'FI', name: 'Finland', name_native: 'Suomi', is_active: true, gym_count: 7, last_updated: null },
    { code: 'SE', name: 'Sweden', name_native: 'Sverige', is_active: true, gym_count: 6, last_updated: null },
    { code: 'PL', name: 'Poland', name_native: 'Polska', is_active: true, gym_count: 10, last_updated: null },
    { code: 'CZ', name: 'Czech Republic', name_native: 'Česko', is_active: true, gym_count: 6, last_updated: null },
    { code: 'SK', name: 'Slovakia', name_native: 'Slovensko', is_active: true, gym_count: 6, last_updated: null },
    { code: 'HU', name: 'Hungary', name_native: 'Magyarország', is_active: true, gym_count: 4, last_updated: null },
    { code: 'RS', name: 'Serbia', name_native: 'Србија', is_active: true, gym_count: 6, last_updated: null },
    { code: 'HR', name: 'Croatia', name_native: 'Hrvatska', is_active: true, gym_count: 4, last_updated: null },
    { code: 'SI', name: 'Slovenia', name_native: 'Slovenija', is_active: true, gym_count: 5, last_updated: null },
    { code: 'BG', name: 'Bulgaria', name_native: 'България', is_active: true, gym_count: 5, last_updated: null },
    { code: 'RO', name: 'Romania', name_native: 'România', is_active: true, gym_count: 4, last_updated: null },
    { code: 'RU', name: 'Russia', name_native: 'Россия', is_active: true, gym_count: 6, last_updated: null },
    { code: 'GE', name: 'Georgia', name_native: 'საქართველო', is_active: true, gym_count: 4, last_updated: null },
  ];
}
...
function getMockGyms(params: DirectorySearchParams): DirectoryGym[] {
  const mockGyms: DirectoryGym[] = [
    {
      id: 'mock-gym-1',
      name: 'Kevin Renno Combat Sports Academy',
      slug: 'kevin-renno-combat-sports-academy',
      country_code: 'EE',
      ...
      phone: null,
      email: null,
      website: 'https://taipoks.ee',
      instagram: 'krva_tallinn',
      facebook: null,
      sports: ['boxing', 'mma', 'muay_thai', 'kickboxing'] as CombatSport[],
      is_claimed: false,
      claimed_by: null,
      claimed_at: null,
      gym_id: null,
    ...
    },
    {
      ...
      country_name: 'Sweden',
      city: 'Stockholm',
      address: 'Svetsarvägen 22, Solna',
      latitude: 59.3626,
      longitude: 17.8725,
      phone: null,
      email: null,
      website: 'https://www.allstarsgym.se',
      instagram: 'allstarstrainingcenter',
      facebook: null,
      sports: ['mma', 'boxing', 'muay_thai', 'kickboxing'] as CombatSport[],
      is_claimed: false,
      claimed_by: null,
      claimed_at: null,
      gym_id: null,
    ...
    {
      id: 'mock-gym-3',
      name: 'FITE Club Budapest',
      slug: 'fite-club-budapest',
      country_code: 'HU',
    ...
    {
      id: 'mock-gym-4',
      name: 'Fight Club Ljubljana',
      slug: 'fight-club-ljubljana',
      country_code: 'SI',
      ...
      phone: null,
      email: null,
      website: 'https://www.fcl.si',
      instagram: 'fcl.ljubljana',
      facebook: null,
      sports: ['boxing', 'kickboxing', 'mma'] as CombatSport[],
      is_claimed: false,
      claimed_by: null,
      claimed_at: null,
      gym_id: null,
    ...
    {
      id: 'mock-gym-5',
      name: 'Kaizen MMA Belgrade',
      slug: 'kaizen-mma-belgrade',
      country_code: 'RS',
      country_name: 'Serbia',
      city: 'Belgrade',
      address: null,
